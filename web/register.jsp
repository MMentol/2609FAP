...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/sources/regstyles.css">
    ...
    <body>        
        ...
        <main>
            <div class="half-side">
                ...
                <p class="body-text">Create an account by inputting an <span class="emphasized">email</span> a <span class="emphasized">username</span>
                    a <span class="emphasized">password</span> and an <span class="emphasized">address</span> in the respective fields provided then accomplish the Captcha to proceed.</p>
            </div>
            <div class="half-side">
